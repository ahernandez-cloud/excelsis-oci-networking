...
variable "compartment_id" {
  type        = string
  description = "OCID del compartment de la VCN TEST."
}
...
variable "vcn_display_name" {
  ...
  default     = "excelsis-test-vcn"
}

variable "vcn_cidr_block" {
  type        = string
  description = "CIDR de TEST."
...
variable "subnets" {
  ...
  description = "Subnets dinámicas para TEST."
  default = {
    private_app = {
      cidr_block = "172.16.33.0/24"
      type       = "private"
      dns_label  = "prvapp"
    }
    public_edge = {
      cidr_block = "172.16.47.0/24"
      type       = "public"
      dns_label  = "pubedge"
    }
  }
